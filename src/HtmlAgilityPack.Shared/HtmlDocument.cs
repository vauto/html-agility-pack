...
namespace HtmlAgilityPack
{
    ...
    public partial class HtmlDocument
    {
        ...
        internal static string HtmlEncodeWithCompatibility(string html, bool backwardCompatibility = true)
        {
            ...
            Regex rx = backwardCompatibility ? HtmlEncodeRegexBackwardCompatibility : HtmlEncodeRegex;
        ...
        public Encoding DetectEncoding(TextReader reader)
        {
            ...
            if (sr != null && !_useHtmlEncodingForStream)
            {
                ...
                // XXX v1.5.0 short-circuits out here, not parsing the document yet.
                // IDK what the consequences of forcing this to happen are.
                // Putting it here for now to better match master.
